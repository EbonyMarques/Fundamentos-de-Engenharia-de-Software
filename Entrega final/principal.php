...
<div class="container-terciaria text-center">
    <form class="form-horizontal" method="POST" action="arq/exibicao.php">
        <fieldset>
            <div class="form-group">
                <label class="col-md-4 control-label"></label>
                <div class="col-md-4">
                    <input align="center" id="t_praia" name="t_praia" type="text" placeholder="ex: piedade, south beach, ses salines, etc." class="form-control input-md" required>
                </div>
            </div>
...
<div class="alert alert-dismissible alert-info text-center">
    Protechted is a platform that results from a project designed by Ebony Marques Rodrigues during the discipline of fundamentals of software <br>engineering, taught by Professor Jones Albuquerque, of the Federal Rural University of Pernambuco in 2017.1. <a href="arq/sobre.html" class="alert-link">Know more</a>.
</div>
